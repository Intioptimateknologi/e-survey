    ...
    >
      <div class="text-center space-y-8">
        ...
        >
          ...
          <span> Service is released now! </span>
        </Badge>
        ...
        >
          <h1>
            ...
            <span
              ...
              >easily with<br>E-Survey
            </span>
          </h1>
        </div>

        <p class="max-w-screen-sm mx-auto text-xl text-muted-foreground">
          Start using our E-Survey and unlock the potential of insightful data
          collection. Access tutorials, resources, and expert support.
        </p>
      ...
      <div class="relative group mt-14">
        ...
        <img
          ...
          :src="
            mode == 'light' ? 'images/landing/hero-light.png' : 'images/landing/hero-dark.png'
          "
